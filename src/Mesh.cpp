...
Mesh Mesh::ship() {
    std::vector<VertexPositionColor> vertices {
            {DirectX::XMFLOAT3(5, 0, 0), {0xFF, 0xFF, 0xFF, 0xFF}},
            {DirectX::XMFLOAT3(0, 0, 2), {0xFF, 0xFF, 0xFF, 0xFF}},
            {DirectX::XMFLOAT3(0, 0, 0), {0xFF, 0xFF, 0xFF, 0xFF}},
            {DirectX::XMFLOAT3(-5, -5, 0), {0xFF, 0xFF, 0xFF, 0xFF}},
            {DirectX::XMFLOAT3(-5, 5, 0), {0xFF, 0xFF, 0xFF, 0xFF}},
    };
